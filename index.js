...
function parseWithStatus (uri, opts) {
  ...
  if (matches) {
    ...
    if (!options.unicodeSupport && (!schemeHandler || !schemeHandler.unicodeSupport)) {
      ...
      // A bracketed IP literal is never a domain name: never hand one to the
      // WHATWG URL parser, whose looser IPv6 grammar would rewrite an address
      // this library has already rejected as malformed.
